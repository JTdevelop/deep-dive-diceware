...
public class Generator {
   ...
   * @throws NegativeArraySizeException this message is to notify that numwords cannot be less than zero
   * @throws IllegalArgumentException this message is to display that the pool of words must be larger than numWords
   */
   ...
   * @throws NegativeArraySizeException this message is to notify that arrays cannot be less than zero.
   */
